...
## Overview
This paper explores how to significantly accelerate instance aggregation so as to make pattern detection online executable.
...
The streaming data of Dataset Vehicle and Sensor can be downloaded from [here](https://drive.google.com/drive/folders/1kdqxAH30vOAQlq2-3J3JEU2QObVxKn5r?usp=sharing).

The complex patterns of Dataset Vehicle and Sensor are placed in ./data. 
## Baselines
To construct the aggregation plan using RW baseline, please run
...
To construct the aggregation plan using SPASS baseline, please run
...
To construct the aggregation plan using the proposed CASEM algorithm, please run
...
For all the methods, evaluate the performances of real-time detection on Vehicle dataset by running
